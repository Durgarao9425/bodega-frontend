...
const CATEGORY_DATA: Record<string, { name: string, img: string }[]> = {
  'Groceries': [
    { name: 'Aata, maida, besan & sooji', img: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?q=80&w=400&h=400&fit=crop' },
    { name: 'Dals, Pulses & Grains', img: 'https://images.unsplash.com/photo-1515543237350-b3eea1ec8082?q=80&w=400&h=400&fit=crop' },
    ...
    { name: 'Rice, Poha & Sabhudana', img: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?q=80&w=400&h=400&fit=crop' },
  ],
  'Households': [
  ...
  'Testing cat': [
    { name: 'Other Items', img: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?q=80&w=400&h=400&fit=crop' }
  ]
};
...
const SubcategoriesPage: React.FC = () => {
  ...
  const items = CATEGORY_DATA[decodedCategory] || DEFAULT_ITEMS;
