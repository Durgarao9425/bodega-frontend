  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-white flex flex-col">
        <Header />
        <div className="max-w-[1200px] mx-auto px-4 py-8 flex-1 w-full animate-pulse flex gap-8">
          <div className="w-1/2 bg-gray-100 h-[500px] rounded-xl"></div>
          <div className="w-1/2 space-y-4 pt-10">
            <div className="h-8 bg-gray-200 w-1/2 rounded"></div>
            <div className="h-4 bg-gray-200 w-1/4 rounded"></div>
            <div className="h-10 bg-gray-200 w-1/3 rounded mt-6"></div>
          </div>
        </div>
      </div>
    );
          ...
          <div className="w-full md:w-[55%] flex flex-col pt-2">
            ...
            <div className="flex items-center gap-5 mt-2">
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center border border-gray-200 rounded h-10 w-28 bg-white shadow-[0_2px_4px_rgba(0,0,0,0.02)]">
              ...
              <button 
                ...
                className="bg-[#007F2D] text-white font-bold px-8 h-10 rounded text-sm hover:bg-[#006e27] transition-colors focus:ring-4 focus:ring-green-100 shadow-md relative disabled:opacity-70 disabled:cursor-not-allowed"
              >
              ...
              <button 
                ...
                className={`w-10 h-10 rounded border flex items-center justify-center transition-colors shadow-sm
                ...
                `}
              >
                <svg stroke="currentColor" fill={isWishlisted ? 'currentColor' : 'none'} strokeWidth="2" viewBox="0 0 24 24" height="20" width="20">
